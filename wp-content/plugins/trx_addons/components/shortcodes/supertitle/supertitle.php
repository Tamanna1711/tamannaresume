				...
				'params' => array_merge(
					array(
						...
						array(
							...
							'description' => wp_kses_data( __("Specify width of the main (left) column from 0 (no left column) to 11 (no right column)", 'trx_addons') ),
							'save_always' => true,
							'edit_field_class' => 'vc_col-sm-6',
							'std' => '8',
							'type' => 'textfield'
							...
							'params' => apply_filters('trx_addons_sc_param_group_params', array_merge(array(
								...
								*/
								...
								array(
									...
									'heading' => esc_html__('Float', 'trx_addons'),
									'description' => '',
									'edit_field_class' => 'vc_col-sm-6',
									'std' => 'left',
//									'dependency' => array(
		...
		class TRX_Addons_Elementor_Widget_Supertitle extends TRX_Addons_Elementor_Widget {
			...
			protected function _register_controls() {
				...
				$this->add_control(
					'header_column',
					[
						'label' => __( 'Left column size', 'trx_addons' ),
